import 'package:app_mmsv3/object-class/local-object-category.dart';
...
import 'package:app_mmsv3/object-class/local-object-state.dart';
import 'package:app_mmsv3/object-class/local-object-user.dart';
import 'package:app_mmsv3/object-class/object-local-air-install.dart';
...
class DBHelper {
  ...
  static Future<List<localLocation>> getLocation(String? stateID, String? categoryID) async {
    final db = await initDb(); // your DB init logic
    final result = await db.rawQuery('''
